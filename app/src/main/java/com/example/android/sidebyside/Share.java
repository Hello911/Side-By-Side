...
public class Share extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener{
    Uri uri1;
    Uri uri2;
    ImageView photo1;
    ImageView photo2;
    ...
    public void onClick(View v){
        switch(v.getId()){
            case R.id.save_collage:
                ...
                image.setImageBitmap(getBitmapOfView(viewGroupLandscape));
                AlertDialog.Builder collageDialog=new AlertDialog.Builder(this).setView(image);
            ...
            case R.id.calculateDifference:
                if(uri1!=null&&uri2!=null) {
                    ...
                    Toast.makeText(Share.this,"Cannot calculate days elapsed. Make sure you have picked both photos.",Toast.LENGTH_SHORT).show();
                }
                break;
    ...
    /**
     * Get a Bitmap screenshot of a view
     * @param v
     * @return
     */
